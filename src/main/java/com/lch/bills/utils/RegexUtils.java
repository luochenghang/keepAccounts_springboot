...
public class RegexUtils {
	...
	/**
	 * 手机号码正则表达式=^(13[0-9]|14[0-9]|15[0-9]|17[0-9]|18[0-9]|19[0-9])\d{8}$
	 */
	...
	/**
	 * 匹配由1个英文字母组成的字符 ^[A-Za-z]{1}$
	 */
	public static final String ONE_STR_ENG = "^[A-Za-z]{1}$";
	...
	public static boolean isLengOut(String str, int len) {
		return isBlank(str) ? false : str.trim().length() > len;
	}
	 ...
	 * @return
	 */
	public static boolean isOneEnglish(String str) {
		return Regular(str, ONE_STR_ENG);
	}
